<?php
    ...
    $PAGE->set_url($CFG->wwwroot.'/local/ned_obe/chairman/display_courses-4.php');
    ...
    if(isset($_GET['tid']))
	{
        ...
        AND usr.id = ?', array('50', 'editingteacher', $tid));

        if($rec){
            ?>
            <form method="post" action="add_mid_and_final.php" id="form_check">
            <?php
            $serialno = 0;
            ...
            if($serialno == 1){
                ...
                redirect('add_mid_and_final.php');
            }
            ...
            echo "<h3>No courses of this teacher found!</h3>";
            echo $OUTPUT->footer();
        }
    }
    else{
