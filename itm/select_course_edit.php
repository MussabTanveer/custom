<?php
    ...
    $PAGE->set_heading("Choose Course to Edit");
    $PAGE->set_url($CFG->wwwroot.'/local/ned_obe/itm/select_course_edit.php');
...
?>
    ...
    <form action="actionfile2.php" class="form-inline">
...
<?php
	...
	$courses=$DB->get_records_sql('SELECT * FROM `mdl_course` WHERE id != ? ORDER BY id DESC', array(1));
