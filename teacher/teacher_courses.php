...
?>
    ...
    if($rec1){
        ...
        foreach ($rec1 as $records) {
            ...
            $table->data[] = array($serialno, "<a href='./report_teacher_past.php?course=$id1'>$fname1</a>", "<a href='./report_teacher.php?course=$id'>$sname1</a>", "<a href='./report_teacher.php?course=$id'>$idnum1</a>");
        }
       // if($serialno == 1){
           // redirect("./report_teacher.php?course=$id");
       // }
