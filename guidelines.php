...
<body>
	...
	<section id="cd-timeline" class="cd-container">
		...
		<div class="cd-timeline-block">
			...
			<div class="cd-timeline-content">
				<h2>Step 11: Add CLOs to Courses</h2>
		...
		<div class="cd-timeline-block">
			...
			<div class="cd-timeline-content">
				<h2>Step 13: Enrol Users</h2>
				<p>Enrol users in course. User roles include Student, Teacher, Manager, etc.</p>
