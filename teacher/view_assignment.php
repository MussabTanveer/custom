...
$table->data[] = array($serialno,strtoupper($userid),$obtmark, "<a href='edit_assignment_marks.php?edit=$marksid&userid=$userid&assignid=$assign_id' title='Edit'><img src='../img/icons/edit.png' /></a>");
