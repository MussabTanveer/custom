...
<?php
    ...
    $PAGE->set_url($CFG->wwwroot.'/local/ned_obe/teacher/view_other.php');
     ...
     echo "<h3>Other Activity</h3><br>";
        ...
        if($rec){
            ...
            foreach ($rec as $records) {
                ...
                $table->data[] = array($serialno,"<a href='./upload_marks_other.php?id=$id&course=$course_id'>$name</a>");
            }
