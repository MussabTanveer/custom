<?php
    ...
    //$id=$_POST['id'];
    //echo $id;
    $rec1=$DB->get_recordset_sql('SELECT ma.name,ma.maxmark,comp.shortname,ma.cloid, comp.id from mdl_manual_other ma,mdl_competency comp WHERE comp.id=ma.cloid AND ma.id=?',array($other_id));
